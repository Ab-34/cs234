...
class BCRegularizationCallback(BaseCallback):
    ...
    def _on_rollout_end(self) -> None:
        """Called after rollout collection, before the PPO gradient update."""

        # --- Anneal lambda linearly to 0 ---
        if self.anneal:
        ...
        # --- Gradient step through PPO's own optimizer ---
...
print("  Value head warmed up. All parameters unfrozen.")
...
save_dir = os.path.join(
    args.save_dir,
    "ppo_trained/bc_ppo_1_1000_complex_Reward_key_11",
